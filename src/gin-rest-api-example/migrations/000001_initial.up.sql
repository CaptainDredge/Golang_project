...
--GameModePopularity
CREATE TABLE GameModePopularity (
    id INT unsigned auto_increment PRIMARY KEY,
    areacode VARCHAR(255) NOT NULL PRIMARY KEY,
    gamemodeid INT UNSIGNED NOT NULL,
    popularity INT NOT NULL,
    UNIQUE KEY unique_gamemodepopularity (areacode, gamemodeid)
) CHARACTER SET utf8mb4;
...
CREATE TABLE GameMode (
    ...
    UNIQUE KEY unique_gamemode_mode (mode)
) CHARACTER SET utf8mb4;
